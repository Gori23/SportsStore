        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                ...
                new Product
                {
                    ...
                    Description = "Przyjemna gra dla całej rodziny. Nawet Sinister nie jest tak ciekawy przy tym co stanie się z Wami!",
                    Category = "Szachy",
                    Price = 75
                },
                new Product
                {
                    ...
                    Description = "Chuj wie co to jest, ale się błyszczy",
                    Category = "Szachy",
                    Price = 1200
                }
);
